...
# cliente = Cliente ('Gian', 123456789, 'Estudante')

# print (cliente.__dict__) #Imprime os atributos em forma de dict
# print (cliente.idade) #AttributeError - o objeto não tem o atributo 'idade'

# cliente.idade = 20 #agora o objeto tem o atributo idade

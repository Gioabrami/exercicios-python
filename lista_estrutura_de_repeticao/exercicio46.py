...
# média dos três valores restantes. Você deve fazer um programa que receba o nome e as cinco distâncias 
...
# programa deve ser encerrado quando não for informado o nome do atleta. A saída do programa deve ser 
...
def prova_de_salto (nome):
    ...
    print (f'Média dos demais saltos: {sum (saltos) / len (saltos):.2f} m')

    print (f'\nResultado Final:\n{nome}: {sum (saltos) / len (saltos):.2f} m\n')

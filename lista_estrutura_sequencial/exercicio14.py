...
if peso > 50:
    ...
    print ("O peso do peixe pescado é de {} kg.".format (peso))
    print ("O peso excedente é de {:.2f} kg, portanto deverá pagar a multa de R$ {:.2f}.".format (excesso, multa))
else:
    print ("O peso do peixe pescado é de {} kg.".format (peso))
    print ("O peso não excede o regulamento de pesca do estado de São Paulo.")